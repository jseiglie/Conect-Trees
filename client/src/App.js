      ...
      <AuthContext.Provider value={{ authState, setAuthState }}>
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/videoblog/admin/dashboard"
              element={<VbAdminDashboard />}
            />
            <Route
              path="/videoblog/admin/editnews/:id"
              element={<VbAdminEditNews />}
            />
            <Route
              path="/videoblog/admin/addnews"
              element={<VbAdminAddNews />}
            />
